...
class _FitnessChatScreenState extends State<FitnessChatScreen> {
  final List<GroupChatMessage> _messages = ChatData.fitnessMotivationMessages;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: const BottomNavigationWidget(currentRoute: '/fitness-chat'),
    );
  }
        ...
        children: [
          if (!message.isCurrentUser) ...[
            Container(
              ...
              decoration: BoxDecoration(
                shape: BoxShape.circle,
                color: message.senderColor ?? const Color(0xFF9C27B0),
                boxShadow: [
                  BoxShadow(
