...
// in fatless/test/screens/onboarding/onboarding_screen_audio_test.dart.
...
import 'package:fatless/models/user_profile.dart' as _i7;
import 'package:fatless/services/user_service.dart' as _i6;
...
class MockUserService extends _i1.Mock implements _i6.UserService {
  ...
  @override
  void setUser(_i7.UserProfile? user) => super.noSuchMethod(
  ...
  String generateUserId(int? targetWeight) =>
      (super.noSuchMethod(
            Invocation.method(#generateUserId, [targetWeight]),
            returnValue: _i4.dummyValue<String>(
              this,
              Invocation.method(#generateUserId, [targetWeight]),
            ),
